...
line_node_t* newline_section(, YYLTYPE loc;
line_node_t* newline_definition(, YYLTYPE loc);
line_node_t* newline_label_db(, YYLTYPE loc);
line_node_t* newline_label_dw(, YYLTYPE loc);
line_node_t* newline_db(, YYLTYPE loc;
line_node_t* newline_dw(, YYLTYPE loc);

...
VIA_BASE = 4000 ; Variables can be defined that way: name, equal sign, expression.
VIA_PORTB = VIA_BASE
...
section text origin 8000     ; The section directive tell the compiler, where to put the machine code or data that comes next.
...
section data  origin 8100
var1:  db 0                       ;0xff                ; We just put 0xff into address 0x8100, to be read in at the start.

section vectors origin 0;xfffc  ; The section for the reset vectors.
